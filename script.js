...
const issues = [
  { id: "door-path", sceneKey: "scene-a", title: "Missing route to the café", instruction: "The storefront entrance is replaced by a plain wall. Click the wall to restore the glass door route.", fixedTitle: "You restored the route into the café.", real: "Customers outside could not enter because the public route ended at a wall instead of a door.", cloud: "This is similar to a public subnet missing a route to an Internet Gateway. Without the route table entry, external users cannot reach public resources.", services: "Amazon VPC, Route Tables, Internet Gateway, Public Subnet" },
  { id: "open-sign", sceneKey: "scene-a", title: "Shop sign shows the wrong state", instruction: "The storefront lightbox incorrectly says CLOSED. Click it to switch the public endpoint back to OPEN.", fixedTitle: "You corrected the storefront sign.", real: "Customers thought the café was closed because the public sign showed the wrong state.", cloud: "This is similar to DNS or domain routing pointing users to the wrong endpoint or unavailable service.", services: "Route 53, DNS, CloudFront or Load Balancer DNS name", textClass: "sign-text", textValue: "OPEN" },
  { id: "guard", sceneKey: "scene-b", title: "Delivery access denied", instruction: "The delivery person is at the warehouse door, but the access keypad says DENIED. Click it to grant the right access.", fixedTitle: "You granted delivery access.", real: "A valid delivery could not reach the stock room because the back-room access rule rejected it.", cloud: "This is similar to IAM, SSM, or private resource access permissions being too restrictive.", services: "IAM Role, Systems Manager Session Manager, private resource access" },
  { id: "chair", sceneKey: "scene-b", title: "Cashier service unhealthy", instruction: "The cat customer reached the counter, but the cashier terminal shows DOWN. Click it to restore service health.", fixedTitle: "You restored cashier service health.", real: "Customers could reach the counter, but the checkout service was unavailable.", cloud: "This is similar to a Load Balancer target becoming unhealthy or an EC2 application service going down.", services: "Elastic Load Balancing, Target Groups, EC2, application health checks" },
  ...
  { id: "coffee-machine", sceneKey: "scene-c", title: "Mouse stealing stock", instruction: "A warning badge marks the corner where the mouse is stealing stock. Click it to stop unauthorized storage access.", fixedTitle: "You stopped unauthorized storage access.", real: "A stock item was being taken from the warehouse without permission.", cloud: "This is similar to an S3 bucket policy or IAM permission allowing unintended access.", services: "S3 Bucket Policy, IAM, Access Analyzer, GuardDuty" },
