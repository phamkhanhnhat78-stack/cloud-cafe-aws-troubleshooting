...
const issues = [
  { id: "door-path", sceneKey: "scene-a", title: "Entrance route is missing floor tiles", instruction: "Someone removed the floor tiles in front of the door. Click the missing-tile route to pave the path back.", fixedTitle: "You paved the route back to the door.", real: "Customers outside could not reach the café entrance safely because the walkway tiles were missing.", cloud: "This is similar to a public subnet missing a route to an Internet Gateway. Without the route table entry, external users cannot reach public resources.", services: "Amazon VPC, Route Tables, Internet Gateway, Public Subnet" },
