...
const issues = [
  ...
  { id: "open-sign", sceneKey: "scene-a", title: "Window sign shows the wrong state", instruction: "A hanging CLOSED sign is stuck on the café window. Click it to switch the public endpoint back to OPEN.", fixedTitle: "You corrected the hanging window sign.", real: "Customers thought the café was closed because the window sign showed the wrong state.", cloud: "This is similar to DNS or domain routing pointing users to the wrong endpoint or unavailable service.", services: "Route 53, DNS, CloudFront or Load Balancer DNS name", textClass: "sign-text", textValue: "OPEN" },
  { id: "guard", sceneKey: "scene-b", title: "Customer queue path is blocked", instruction: "A red queue barrier blocks the cat customer from lining up at the cashier. Click it to clear the customer path.", fixedTitle: "You cleared the customer queue path.", real: "The customer could enter the café, but an unnecessary barrier stopped them from joining the cashier queue.", cloud: "This is similar to valid user traffic reaching the frontend but being blocked by a Security Group, Network ACL, or routing rule before it reaches the application path.", services: "Security Groups, Network ACL, route rules, application traffic path" },
